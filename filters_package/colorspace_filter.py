...
choices = {'RGB->HLS':cv.CV_RGB2HLS,
           'RGB->HSV':cv.CV_RGB2HSV,
           'RGB->XYZ':cv.CV_RGB2XYZ,
           'RGB->YCrCv':cv.CV_RGB2YCrCb,
           'RGB->Lab':cv.CV_RGB2Lab,
           'RGB->Luv':cv.CV_RGB2Luv,
           'HLS->RGB':cv.CV_HLS2RGB,
           'HSV->RGB':cv.CV_HSV2RGB,
           'YCrCv->RGB':cv.CV_YCrCb2RGB,
           'Lab->RGB':cv.CV_Lab2RGB,
           'Luv->RGB':cv.CV_Luv2RGB}
...
class Colorspace_filter(Filter_base):
    ...
    def process(self, input_images, connected_outs):
        ...
        dst = cv2.cvtColor(src, conversion_type)    
